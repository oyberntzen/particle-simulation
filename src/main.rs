...
fn galaxy_collision() {
    ...
    milkyway1.add_position(simulation::Vector2 { x: -30.0, y: -30.0 });
    milkyway2.add_position(simulation::Vector2 { x: 30.0, y: 30.0 });

    milkyway1.add_velocity(simulation::Vector2 { x: 1.0, y: 1.0 });
    milkyway2.add_velocity(simulation::Vector2 { x: -1.0, y: -1.0 });
